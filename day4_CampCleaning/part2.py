...
def isOverlapped(l):
    if (l[1] < l[2]): return False # First Assignment ends before the Second Assignment Starts
    if (l[3] < l[0]): return False # Second Assignment ends before the First Assignment Starts
    return True
